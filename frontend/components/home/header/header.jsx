      ...
      return (
        <section className="top-header">
          ...
          <div className="user-input">
            ...
            <button className="password" onClick={this.logOutClick}>
              Sign Out
            </button>
          </div>
        </section>
  ...
  navbar() {
    return (
      <navbar className="nav-bar">
        ...
        <HashLink id="top-albums-link" className="hover-link" to="/#top-albums">
          Top Albums
        </HashLink>
        <span id="first-bar">|</span>
        ...
        <a
          id="linkedin-icon"
          className="hover-link"
          href="https://www.linkedin.com/in/john-baek-49b6114a/"
          target="_blank"
        >
          <LinkedIN size={25} />
        </a>
        <a
          id="github-icon"
          className="hover-link"
          href="https://github.com/johnbaek92"
          target="_blank"
        >
          <Github size={28} />
        </a>
